package FRDCSA::BehaviorTreeStarterKit::ActiveSelector;
...
FRDCSA::BehaviorTreeStarterKit::ActiveSelector -
...
sub update {
  ...
  FRDCSA::BehaviorTreeStarterKit::Selector::onInitialize($self);
  my $result = FRDCSA::BehaviorTreeStarterKit::Selector::update($self);
